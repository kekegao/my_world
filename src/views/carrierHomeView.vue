  ...
  <div class="carrier-home-app">
    ...
    <header class="hero">
      <div class="hero-brand">
        ...
        <span class="hero-title">智运宝 · 承运方端</span>
      </div>
      <h1 class="hero-greet">你好，{{ displayName }}</h1>
      <p class="hero-sub">海量货源在线摘单，承接运输全程可视</p>
    </header>
      ...
      <section class="quick-section">
        <button type="button" class="quick-card quick-account" @click="goAccount">
          ...
          <span class="quick-main">
            ...
            <small class="quick-desc">充值提现 · 运费结算</small>
          </span>
        ...
        <button type="button" class="quick-card quick-order" @click="goAcceptOrder">
          <span class="quick-icon">
            <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <path d="M13 2 4.5 13.5H11L9.5 22 19 10h-6.5L13 2z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" />
            </svg>
          </span>
          <span class="quick-main">
            <b class="quick-name">我去摘单</b>
            <small class="quick-desc">货源大厅 · 抢单接单</small>
          </span>
          <svg class="quick-arrow" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path d="M9 5l7 7-7 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
